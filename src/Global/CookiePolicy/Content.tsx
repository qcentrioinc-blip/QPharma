...
<div
  ...
  style={{
    minHeight: "420px",
    backgroundImage: "url('/Global/policybg.png')",
  }}
>
...
<div className="relative overflow-hidden ">
  ...
  <img
    src="/Global/GradientBox.png"
    alt="gradient"
    className="absolute top-20 right-0 w-[300px]  lg:w-[400px] rotate-180 opacity-80 pointer-events-none select-none"
  />

  <img
    src="/Global/GradientBox.png"
    alt="gradient"
    className="absolute bottom-20 left-0 w-[250px]  lg:w-[400px]  opacity-60 pointer-events-none select-none"
  />
        {/* Section 1 */}
