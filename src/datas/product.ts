...
export const products: Product[] = [
  {
    ...
    description: "Premium immune support Premium immune support Premium immune support.",
    badge: "MOQ: 1000 units",
    bulk: "Bulk Pack",
    moq: "MOQ: 10000 units",
    extra: "Orange",
  ...
  },
  {
    ...
    description: "Supports stress relief and vitality. Premium immune support",
    badge: "MOQ: 10000 units",
    bulk: "Bulk Pack",
    moq: "MOQ: 8000 units",
    extra: "Root Extract",
  ...
  },
  {
    ...
    description: "Heart and brain health support. Premium immune support",
    badge: "MOQ: 10000 units",
    bulk: "Bulk Pack",
    moq: "MOQ: 12000 units",
    extra: "Fish Oil",
...
for (let i = 4; i <= 9; i++) {
  products.push({
    ...
    description: `Lorem ipsum product Premium immune support ${i}.`,
    badge:  `MOQ: ${i * 2000} units`,
    bulk: "Bulk Pack",
